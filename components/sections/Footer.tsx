...
export function Footer({ name, githubUrl, instagramUrl, linkedinUrl }: FooterProps) {
  ...
  return (
    <footer className="border-t-3 border-border bg-surface">
      <div className="section-padding max-w-6xl mx-auto py-8 md:py-12">
          ...
          <div className="flex items-center gap-3">
            {linksToRender.map((link) => (
              <a
                ...
                className="neo-btn p-2 bg-surface text-on-surface hover:bg-secondary hover:text-primary dark:hover:text-tertiary cursor-pointer"
        ...
        <div className="mt-8 text-center">
          <a
            href="#home"
            className="label text-muted hover:text-secondary transition-colors duration-200 cursor-pointer"
          >
            ↑ Back to top
          </a>
        </div>
